...
class GMT:
    # genes_cols : start reading genes from genes_col(default 1, it can be 2 e.g. if an information col is added
    # after the pathway col) pathway col is considered to be the first column (0)
